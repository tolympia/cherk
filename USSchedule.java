// TOZ, January 2023.
// Represents the Upper School schedule for a specific date.
// Inherits from the abstract Schedule class.
import java.util.*;
import java.time.*;
...
public abstract class USSchedule extends Schedule {
  ...
  // Keep track of which dates correspond to adjusted schedules.
  ...
  // Initializes holidays to include winter and spring break.
  static {
